...
export function ContactForm() {
  ...
  if (status === "success") {
    return (
      <div
        role="status"
        className="w-full max-w-xl rounded-xl border border-primary/30 bg-primary/10 px-6 py-8 text-center"
      >
...
export function ClosingContactSection() {
  return (
    <section id={CONTACT_SECTION_ID} className="py-20 sm:py-28">
      <Container className="flex flex-col items-center gap-10 text-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="max-w-xl text-lg text-muted-foreground text-balance">
            Contanos tu principal desafío y te mostramos por dónde empezar.
          </p>
        </div>
